...
最終更新: 2026-07-23（夏開催の脚質別展開有利度を複数年検証し、小倉芝へ参考表示を追加） / 担当: OpenAI Codex / ブランチ `claude/sweet-einstein-ilnaov`
...
- [x] ✅ **P2 函館・小倉の夏開催における脚質別展開有利度を複数年で検証する**
  ...
  - 係数・PAI・順位は変更せず、7月の小倉芝だけ`style-advantage-v2`で`reference`を返す。
